...
public class PleaseExpressionImpl extends ASTWrapperPsiElement implements PleaseExpression {

  public PleaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PleaseOperator getOperator() {
    return findChildByClass(PleaseOperator.class);
  }

  @Override
  @NotNull
  public PleaseValue getValue() {
    return findNotNullChildByClass(PleaseValue.class);
  }
